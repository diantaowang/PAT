...
int main()
{
    ...
    for(k1 = 0, k2 = 0; k1Ploynomials[k1].index != 0 || k2Ploynomials[k2].index != 0; )
	{
		...
		{
			Ploynomials[i].coeff = k1Ploynomials[k1].coeff + k2Ploynomials[k2].coeff;
			if(Ploynomials[i].coeff != 0)
			{
				Ploynomials[i++].index = k1Ploynomials[k1].index;
			}
			k1++;
			k2++;
		}
